...
var ch = window.ch = {
     ...
     * @memberOf ch
     */
    components: "calendar,carousel,custom,dropdown,expando,form,helper,layer,menu,modal,number,required,tabNavigator,tooltip,viewer,zoom,string",
    /**
