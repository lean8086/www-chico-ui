...
var ch = window.ch = {
     ...
     * @memberOf ch
     */
    components: "calendar,carousel,chat,custom,dropdown,expando,form,helper,layer,menu,modal,number,required,string,tabNavigator,tooltip,viewer,zoom",
    /**
